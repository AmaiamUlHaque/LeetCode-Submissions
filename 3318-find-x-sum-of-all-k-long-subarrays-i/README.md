...
<p>The <strong>x-sum</strong> of an array is calculated as follows:</p> <ul> <li>Sort the array in non-decreasing order.</li> <li>If the length of the array is at least <code>x</code>, sum the last <code>x</code> elements of the sorted array. Otherwise, sum all elements.</li> </ul><p>Return an array <code>ans</code> of length <code>n - k + 1</code> where <code>ans[i]</code> is the <strong>x-sum</strong> of the subarray <code>nums[i..i + k - 1]</code> of length <code>k</code>.
